...
export const JET_OPTIONS = [
    { imageUrl: '../../../assets/body-1.png', name: 'Jet free' },
    { imageUrl: '../../../assets/body-2.png', name: 'digi free' },
    { imageUrl: '../../../assets/digi-p.png', name: 'digi-p' },
    { imageUrl: '../../../assets/body-4.jpg', name: 'Remote' },
    { imageUrl: '../../../assets/body-9.png', name: 'Pen' },
    { imageUrl: '../../../assets/digi-mehr.png', name: 'Mehr' },
    { imageUrl: '../../../assets/body-7.png', name: 'Digi+' },
    { imageUrl: '../../../assets/body-8.png', name: 'Digi Jet' },
]